@echo off
echo =============================================
echo Fix MySQL Authentication for Local
echo =============================================
...
mysql -u root -p -e "CREATE USER IF NOT EXISTS 'sa'@'%' IDENTIFIED WITH mysql_native_password BY 'sapassword';"
...
mysql -u sa -psapassword -e "USE movie_ticket_db; INSERT INTO test (id, name) VALUES (1, 'Test Local');"
...
echo =============================================
echo Local MySQL authentication fixed!
echo =============================================
echo.
