...
(3, 1, 5, 'Phim hay tuyệt vời! Hiệu ứng đẹp mắt.', 1),
...
-- Insert Promotions
-- =============================================
INSERT INTO promotions (code, name, description, discount_percentage, min_order_amount, start_date, end_date) VALUES
('WELCOME10', 'Chào mừng khách hàng mới', 'Giảm 10% cho đơn hàng đầu tiên', 10.00, 100000, '2023-01-01', '2023-12-31'),
('VIP20', 'Khách hàng VIP', 'Giảm 20% cho khách hàng VIP', 20.00, 200000, '2023-01-01', '2023-12-31'),
('WEEKEND15', 'Cuối tuần vui vẻ', 'Giảm 15% cho suất chiếu cuối tuần', 15.00, 150000, '2023-01-01', '2023-12-31');
