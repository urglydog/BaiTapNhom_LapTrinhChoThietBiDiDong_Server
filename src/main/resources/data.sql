...
VALUES ('admin', 'admin@movieticket.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi',
       ...
       ('staff1', 'staff1@movieticket.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi',
        'Nguyễn Văn A', '0987654321', '1995-05-15', 'MALE', 'STAFF'),
       ('customer1', 'customer1@gmail.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi',
        'Trần Thị B', '0912345678', '1998-08-20', 'FEMALE', 'CUSTOMER'),
       ('customer2', 'customer2@gmail.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi', 'Lê Văn C',
...
VALUES ('CGV Vincom Center', '72 Lê Thánh Tôn, Quận 1, TP.HCM', 'Ho Chi Minh City', '1900 6017', 'cgv@cgv.vn',
        'Rạp chiếu phim hiện đại với công nghệ IMAX'),
       ('Lotte Cinema Diamond Plaza', '34 Lê Duẩn, Quận 1, TP.HCM', 'Ho Chi Minh City', '1900 1533', 'lotte@lotte.vn',
        'Rạp chiếu phim cao cấp với ghế VIP'),
       ('Galaxy Cinema Nguyễn Du', '116 Nguyễn Du, Quận 1, TP.HCM', 'Ho Chi Minh City', '1900 2224', 'galaxy@galaxy.vn',
        'Rạp chiếu phim với nhiều phòng chiếu'),
       ('BHD Star Cineplex', '59A Lý Tự Trọng, Quận 1, TP.HCM', 'Ho Chi Minh City', '1900 6363', 'bhd@bhd.vn',
        'Rạp chiếu phim với công nghệ 4DX');

-- =============================================
-- Insert Cinema Halls
-- =============================================
INSERT INTO cinema_halls (cinema_id, hall_name, total_seats)
VALUES (1, 'Phòng 1 - IMAX', 200),
...
VALUES ('Avatar: The Way of Water',
        'Jake Sully và gia đình của anh ấy khám phá những vùng biển của Pandora và gặp gỡ những sinh vật biển kỳ lạ.',
       ...
       ('Black Panther: Wakanda Forever',
        'Sau cái chết của Vua T''Challa, Wakanda phải đối mặt với những thách thức mới.', 161, '2022-11-11',
        '2023-02-11', 'Action, Adventure', 'Ryan Coogler', 'Letitia Wright, Angela Bassett, Lupita Nyong''o', 7.8,
        'English', 'Vietnamese', 'PG-13'),
       ('Top Gun: Maverick', 'Pete "Maverick" Mitchell trở lại với nhiệm vụ nguy hiểm nhất trong sự nghiệp của mình.',
       ...
       ('Spider-Man: No Way Home', 'Peter Parker cần sự giúp đỡ của Doctor Strange để che giấu danh tính của mình.',
       ...
       ('The Batman',
        'Khi một kẻ giết người hàng loạt bắt đầu tàn sát giới thượng lưu của Gotham, Batman phải điều tra.', 176,
        '2022-03-04', '2022-09-04', 'Action, Crime', 'Matt Reeves', 'Robert Pattinson, Zoë Kravitz, Paul Dano', 8.2,
        'English', 'Vietnamese', 'PG-13');
...
VALUES (3, 1, 5, 'Phim hay tuyệt vời! Hiệu ứng đẹp mắt.', 1),
       (4, 1, 4, 'Tốt nhưng hơi dài.', 1),
       (3, 2, 5, 'Black Panther tuyệt vời!', 1),
       (4, 3, 5, 'Top Gun Maverick hay quá!', 1),
       (3, 4, 4, 'Spider-Man No Way Home thú vị.', 1);
